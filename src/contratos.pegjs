...
S_Class = "class " className:class_name sentences:class_sentences {return {type:"class", class:className, sentences}}
...
method_content = name:typed_variable signatures:method_signatures {return {name, signatures}}
method_signatures = uses_packages_sentence? uses_classes_sentence? uses_processes_sentence? that_receives? that_modifies? that_returns? described_as?
...
S_Package = "package " packageName:package_name sentences:package_sentences {return {type:"package", package: packageName, sentences}}
package_sentences = from_file_sentence? 

S_Process = "process " processName:process_name sentences:process_sentences {return {type:"process", process: processName, sentences}}
process_sentences = from_file_sentence? method_signatures
